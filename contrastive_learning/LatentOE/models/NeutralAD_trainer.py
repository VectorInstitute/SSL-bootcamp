...
class NeutralAD_trainer:
    def __init__(self, model, loss_function, config):  # type: ignore
    ...
    def _train(self, epoch, train_loader, optimizer):  # type: ignore
        self.model.train()
        loss_all = 0
    ...
    def detect_outliers(self, loader):  # type: ignore
        model = self.model
        model.eval()
