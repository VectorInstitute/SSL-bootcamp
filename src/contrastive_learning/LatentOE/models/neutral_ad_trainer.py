...
class NeutralADTrainer:
    ...
    def __init__(self, model: nn.Module, loss_function: nn.Module, config: "Config") -> None:
    ...
    def _train(self, epoch: int, train_loader: DataLoader, optimizer: Optimizer) -> float:
