...
class PYOD:
    ...
    def grid_search(self, X_train: np.ndarray, y_train: np.ndarray, ratio: float) -> Optional[dict]:
        ...
        if param_grid is not None:
            ...
            # validation set (and the same anomaly ratio as in the original dataset)
            X_val = X_train[idx]
            y_val = y_train[idx]
